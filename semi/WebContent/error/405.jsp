...
<br><br><br><br><br><br><br><br><br>
				...
				<br>
<h2 class="hrline" width=100% align="center">405 Method not allowed(메소드가 허용하지 않습니다)</h2>
<div class="all">
	<div class="login-wrap">
		<div style="display: table; width: 350;">
			<div class="display:table-cell; vertical-align:center;">
				...
				<p> 이 에러는 Request 라인에 명시된 <br> 메소드를 수행하기 위해 해당 자원의 이용이 <br>허용되지 않았을 때 발생합니다.</p>
				</div>
		</div>
	</div>
</div>
